...
`)])],-1),D=s("h2",{id:"reference"},[e("Reference "),s("a",{class:"header-anchor",href:"#reference"},"#")],-1),T=s("h3",{id:"constructor"},[e("Constructor "),s("a",{class:"header-anchor",href:"#constructor"},"#")],-1),I=s("p",null,[e("This is the starting point to use the SDK. You need to create an instance and invoke methods from it. In most cases a single instance is sufficient, but in case you need more, you need to define "),s("a",{href:"#options.storage.prefix"},[s("code",null,"options.storage.prefix")]),e(".")],-1),x=s("pre",null,[s("code",{class:"language-js"},[s("span",{class:"hljs-keyword"},"import"),e(" { Directus } "),s("span",{class:"hljs-keyword"},"from"),e(),s("span",{class:"hljs-string"},"'@directus/sdk'"),e(`;
...
`)],-1),Ie=s("p",null,[e("Same methods as "),s("code",null,'directus.items("directus_permissions")'),e(".")],-1),xe=s("h2",{id:"presets"},[e("Presets "),s("a",{class:"header-anchor",href:"#presets"},"#")],-1),Ae=s("pre",null,[s("code",{class:"language-js"},`directus.presets;
...
`)])],-1),Tt=s("p",null,[e("This will move item "),s("code",null,"15"),e(" to the position of item "),s("code",null,"42"),e(", and move everything in between one \u201Cslot\u201D up.")],-1),It=s("h3",{id:"revert-to-a-previous-revision"},[e("Revert to a Previous Revision "),s("a",{class:"header-anchor",href:"#revert-to-a-previous-revision"},"#")],-1),xt=s("pre",null,[s("code",{class:"language-js"},[s("span",{class:"hljs-keyword"},"await"),e(" directus.utils.revert("),s("span",{class:"hljs-number"},"451"),e(`);
`)])],-1),At=s("p",null,"Note: The key passed is the primary key of the revision you\u2019d like to apply.",-1),Rt=s("hr",null,null,-1),Pt={setup(Bt,{expose:l}){const t={title:"JavaScript SDK",modularExtension:!1};return l({frontmatter:t}),(Mt,qt)=>{const o=a("router-link"),c=a("DocsWrapper");return i(),r(c,{frontmatter:t},{default:n(()=>[s("div",d,[p,u,j,m,_,g,f,y,w,k,b,v,S,D,T,I,x,A,R,B,M,q,C,P,U,O,E,F,K,N,W,L,z,V,G,s("div",J,[Y,s("p",null,[H,h(o,{to:"/docs/configuration/config-options/#security"},{default:n(()=>[Q]),_:1}),$])]),X,Z,ss,es,ts,as,ns,ls,os,cs,is,rs,hs,ds,ps,us,js,ms,_s,gs,fs,ys,ws,ks,bs,vs,Ss,Ds,Ts,Is,xs,As,Rs,Bs,Ms,qs,Cs,Ps,Us,Os,Es,Fs,Ks,Ns,Ws,Ls,zs,Vs,Gs,Js,Ys,Hs,Qs,$s,Xs,Zs,se,ee,te,ae,ne,le,oe,ce,ie,re,he,de,pe,ue,je,me,_e,ge,fe,ye,we,ke,be,ve,Se,De,Te,Ie,xe,Ae,Re,Be,Me,qe,Ce,Pe,Ue,Oe,Ee,Fe,Ke,Ne,We,Le,ze,Ve,Ge,Je,Ye,He,Qe,$e,Xe,Ze,st,et,tt,at,nt,lt,ot,ct,it,rt,ht,dt,pt,ut,jt,mt,_t,gt,ft,yt,wt,kt,bt,vt,St,Dt,Tt,It,xt,At,Rt])]),_:1})}}};export{Pt as default};
